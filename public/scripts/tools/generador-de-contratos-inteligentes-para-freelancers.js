/* HYDRA WIDGET | generador-de-contratos-inteligentes-para-freelancers | simulator | es */
/* Generated: 2026-04-14 — DO NOT EDIT MANUALLY */
(function () {
  'use strict';

  const TOOL_ID   = 'generador-de-contratos-inteligentes-para-freelancers';
  const TOOL_TYPE = 'simulator';
  const LANG      = 'es';
